    ...
    $("#submit-button").on("click", function(event) {
        ...
        if (searchType === "Title") {
            ...
            $.ajax({
                ...
                $("#plot-synopsis").html(
                    "<div class='card' style='width: 200px;'><img class='card-img-top' src='" + moviePosterSize + response.results[0].poster_path + "' alt='Movie Poster'><div class='card-body><h5>" + response.results[0].title + "</h5><p class='card-text'>" + response.results[0].overview + "</p><a href='#' class='btn btn-primary>See Info</a></div></div>"
                );
            });
